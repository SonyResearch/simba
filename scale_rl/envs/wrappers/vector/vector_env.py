# A Copy and Modification from Gymnasium 0.29 API
...
class VectorObservationWrapper(VectorEnvWrapper):
    ...
    def observations(self, observations: NDArray[Any]) -> NDArray[Any]:
...
class VectorActionWrapper(VectorEnvWrapper):
    ...
    def actions(self, actions: NDArray[Any]) -> NDArray[Any]:
...
class VectorRewardWrapper(VectorEnvWrapper):
    ...
    def rewards(self, rewards: NDArray[Any]) -> NDArray[Any]:
